      ...
      <nav className="relative z-10 px-6 py-4" style={{ borderBottom: '1px solid rgba(245,158,11,0.1)' }}>
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-sm text-[#57534e]">
            ...
            <Link href="/signup" className="text-[#f59e0b] hover:text-[#fbbf24] font-semibold transition-colors">
              Sign up
            </Link>
          </div>
        </div>
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#57534e] text-sm">Continue your chess journey</p>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xs text-[#44403c]">or sign in with email</span>
              <div className="flex-1 h-px" style={{ background: 'rgba(255,255,255,0.06)' }} />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-sm font-medium text-[#a8a29e]">Password</label>
                  <Link
          ...
          <p className="text-center text-xs text-[#292524] mt-6">
            ...
            <Link href="/terms" className="text-[#44403c] hover:text-[#57534e] underline">Terms</Link>
            {' '}and{' '}
            <Link href="/privacy" className="text-[#44403c] hover:text-[#57534e] underline">Privacy Policy</Link>
          </p>
        </div>
      </div>
